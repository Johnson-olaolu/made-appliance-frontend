...
const Offers = () => {
  return (
    <>
      ...
      <div className=" sm:hidden items-center grid grid-cols-2 gap-4">
        <div className="h-60 col-span-2 bg-gray-200"></div>
        <div className="h-28 bg-[#C1DAF9]"></div>
        <div className="h-28 bg-[#C1DAF9]"></div>
        {/* <div className="h-36 w-80 bg-gray-200"></div>
        <div className="h-36 w-80 bg-gray-200"></div> */}
      </div>
    </>
  );
