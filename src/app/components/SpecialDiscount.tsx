...
const SpecialDiscount = () => {
  return (
    <div className="h-40 w-full p-8 relative" style={{ background: `url("/images/Mask group8724.png")` }}>
      <div className="flex items-center gap-16 h-full">
        <div className="h-full flex flex-col justify-between max-w-[516px]">
      ...
      <Image width={272} height={204} src={"/images/image 15.png"} alt="" className="absolute bottom-0 right-0" />
    </div>
  );
};
